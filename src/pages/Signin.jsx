      ...
      <div className="w-full max-w-100">
        ...
        <div className="flex flex-col gap-3">
          <button className="flex items-center justify-center gap-3 w-full bg-[#121212] border border-[#2d2d2d] py-4 rounded-full font-bold hover:bg-[#1c1c1c] transition-all">
            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg>
        ...
        <div className="mt-10 text-center text-[15px]">
          ...
          <Link to="/signupMain" className="text-[#0052FF] hover:underline font-medium">Sign up</Link>
        </div>
        ...
        <p className="warning text-center">Demo app – do not use your real password.</p>
      </div>
    </div>
  );
}